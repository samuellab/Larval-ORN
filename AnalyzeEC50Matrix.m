...
disp('Reference: http://tuvalu.santafe.edu/~aaronc/powerlaws/');
disp('PDF: p(x) = x^-alpha, for x >= xmin');
...
set(gca,'YTickLabel',infoORNList(load_index));
...
N = 1000;
explainedMatrix = zeros(rows-1, N);
