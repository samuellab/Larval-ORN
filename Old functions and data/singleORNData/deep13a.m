...
disp(['Kd_1 = ', num2str(mean(kdVecfs2(1:12))), ' +- ',  num2str(std(kdVecfs2(1:12))/sqrt(12))]);
disp(['Kd_2 = ',num2str(mean(kdVecfs2(13:24))), ' +- ',  num2str(std(kdVecfs2(13:24))/sqrt(12))]);
disp(['Amp_1 = ', num2str(mean(ampVecfs2(1:12))), ' +- ',  num2str(std(ampVecfs2(1:12))/sqrt(12))]);
disp(['Amp_2 = ',num2str(mean(ampVecfs2(13:24))), ' +- ',  num2str(std(ampVecfs2(13:24))/sqrt(12))]);
...
disp(['Kd_1 = ', num2str(mean(kdVecfs3(1:12))), ' +- ',  num2str(std(kdVecfs3(1:12))/sqrt(12))]);
disp(['Kd_2 = ',num2str(mean(kdVecfs3(13:24))), ' +- ',  num2str(std(kdVecfs3(13:24))/sqrt(12))]);
disp(['Amp_1 = ', num2str(mean(ampVecfs3(1:12))), ' +- ',  num2str(std(ampVecfs3(1:12))/sqrt(12))]);
disp(['Amp_2 = ',num2str(mean(ampVecfs3(13:24))), ' +- ',  num2str(std(ampVecfs3(13:24))/sqrt(12))]);
