...
opts.Lower = [0 slop -11]; % setup the range and initial value of the variable
opts.Upper = [max(rspTs(:))*1.5 slop 0];
opts.StartPoint = [4 slop -7];
...
[ftCol, ftRow] = find(maskPlot' == 2 | maskPlot' == 1);
% gfX2 = [];  gfY2 = [];
