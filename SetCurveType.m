...
typeMask(3, 4) = 3;     %6-methyl-5-hepten-2-ol 35a;
...
typeMask(5, 11) = 3;    %trans-3-hexen-1-ol 67b; 
% maskPlot(5, 12) = 3;    %trans-3-hexen-1-ol 85c;  <0.5
typeMask(5, 13) = 3;    %trans-3-hexen-1-ol 13a;
...
typeMask(10, 10) = 3;   %pentyl acetate 24a; 
...
typeMask(11, 1) = 1;    %geranyl acetate 33b; S
...
typeMask(12, 6)  = 3;   %2-methoxyphenyl acetate 59a; 
...
typeMask(13, 4) = 3;    %trans,trans-2,4-nonadienal 35a; 
...
typeMask(15, 6) = 2;    %4,5-dimethylthiazole 59a; not flat
typeMask(15, 8) = 3;    %4,5-dimethylthiazole 45b;
typeMask(15, 11) = 3;   %4,5-dimethylthiazole 67b;

typeMask(16, 1) = 3;    %4-hexen-3-one 33b;
...
typeMask(16, 12) = 3;   %4-hexen-3-one 85c;
...
typeMask(17, 4) = 3;    %2-nonanone 35a; 
...
typeMask(20, 13) = 3;	%butyl acetate 13a;
...
typeMask(21, 5) = 3;	%ethyl acetate 42a;
...
typeMask(23, 2) = 3;	%2-heptanone 45a; 
...
typeMask(25, 1) = 3;	%ethyl butyrate 33b/47a;
typeMask(25, 2) = 3;	%ethyl butyrate 45a;
typeMask(25, 3) = 3;	%ethyl butyrate 83a;
typeMask(25, 4) = 3;	%ethyl butyrate 35a;
...
typeMask(25, 18) = 3;	%ethyl butyrate 33a;

typeMask(26, 1) = 1;	%isoamyl acetate 33b/47a; S
typeMask(26, 2) = 3;	%isoamyl acetate 45a;
...
typeMask(27, 4) = 3;	%4-methylcyclohexane 35a;
...
typeMask(28, 12) = 2;	%hexyl acetate 85c;  
...
typeMask(30, 9) = 2;	%benzyl acetate 63a; 
...
typeMask(31, 13) = 3;	%4-pheny-2-butanol 13a; 
...
typeMask(32, 9) = 3;	%myrtenal 63a; 
typeMask(32, 10) = 3;	%myrtenal 24a; 
